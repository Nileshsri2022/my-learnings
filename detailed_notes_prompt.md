...
🌳 Concept Tree (for any topic with hierarchy/nesting)
Main Topic
├── Sub-concept A
│   ├── Detail A1
│   └── Detail A2
...
📝 Summary (5-10 bullet TL;DR — scale with complexity)
...
• Emoji section anchors ONLY:
  📌 topic  📑 TOC  🔹 section  📖 definitions
  📐 formulas  ⚡ recall  🔗 connections  💡 examples
  ⚠️ warnings  📝 summary  🆚 comparisons  🌳 tree
...
═══════════════════════════════════════════════════════════
STEP 6 — QUALITY GATE (verify before output)
═══════════════════════════════════════════════════════════
...
═══════════════════════════════════════════════════════════
FLAGS (combine freely — default = detailed + comprehensive)
═══════════════════════════════════════════════════════════
